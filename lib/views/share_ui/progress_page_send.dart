...
class ProgressPageSend extends StatefulWidget {
  final SenderModel? senderModel;
  final int secretCode;
  const ProgressPageSend({
    Key? key,
  ...
  @override
  State<ProgressPageSend> createState() => _ProgressPageSendState();
}

class _ProgressPageSendState extends State<ProgressPageSend> {
  @override
  void initState() {
    super.initState();
