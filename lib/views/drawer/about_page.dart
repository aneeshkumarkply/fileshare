            ...
            body: ListView(
              children: [
                ...
                ListTile(
                  ...
                  onTap: () {
                    var url = Mailto(
                      to: ['aneeshkumarkply@gmail.com'],
                    ).toString();
                    launchUrl(Uri.parse(url));
                  },
                  title: const Text('Email'),
                  subtitle: const Text('aneeshkumarkply@gmail.com'),
                ),
                ListTile(
                  leading:
                      const Icon(UniconsLine.twitter, color: Colors.blueAccent),
                  onTap: () {
                    launchUrl(Uri.parse('https://twitter.com/aneeshkumarkply'));
                  },
                  title: const Text('Twitter'),
                  subtitle: const Text('https://twitter.com/aneeshkumarkply'),
                ),
                Padding(
