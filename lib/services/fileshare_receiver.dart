...
import 'package:fileshare/services/file_services.dart';
...
class FileShareReceiver {
  ...
  ///scan presence of fileshare-server[driver func]
  static Future<List<SenderModel>> scan() async {
    List<Future<Map<String, dynamic>>> list = [];
    List<SenderModel> fileshareServers = [];
